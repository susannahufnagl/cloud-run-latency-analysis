...
STAGE_LABEL="${STAGE_LABEL:-S${STAGE}_concurrent}"  #beim independent-Skript: S0_independent und zahl dynamisch übergeben  
...
#Stage 0: beide Endpunkte gleichzeitig pro Runde 
...
: "${COUNT:=500}"       
: "${SLEEP:=0.2}"       #Pause zwischen Runden 
